...
Das System wird, wenn es im Einsatz ist, auf einem Server gestartet. In der Entwicklungsphase starten wir das System über "localhost:8080"
...
QR-Code-Scanner und Websocket


== Lösungsstrategie
- Trennung Product und DistributorProduct
- Bootstrap als Frontend-Framework
...
=== Persistenz
Wir haben uns für eine persistente Datenbank entschiedenm weil wir eine Vielzahl von Produkten und Kunden
haben und außerdem für die Statistik Daten dauerhaft abgespeichert werden müssen.
