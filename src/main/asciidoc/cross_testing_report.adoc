...
- *bearbeiten (irgendwelche kritischen Daten aber nicht -> Fehler [AT012])*
- *Nachfrage, ob Angestellter wirklich gelöscht werden soll [AT013]*

* *Inventur durchführen [AT107]*
- *die im Warenkorb sind [AT102]*
* *verschiedene Anzeigeoptionen [AT004]*
...
- keine UUIDs sondern einfache Longs für die identifikation verwednden. (https://docs.jboss.org/hibernate/orm/5.0/mappingGuide/en-US/html/ch06.html[mal durchlesen!])
