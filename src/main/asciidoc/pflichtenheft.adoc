...
|12.11.2018
|Lisa, Lukas
|Muss-Kriterien überarbeitet

|1.1.1
|abgeschlossen
|11.12.2018
|Adrian
|Musskriterien für Datenbankbegrenzung gestrichen
...
ID: 1. Buchstabe: A - Allgemein U - UserDepartment, P - ProductDepartment , D - DataDepartment, O - OrderDepartment, F - FinancesDepartment +
2. Buchstabe: F - Funktionale Anforderung
3. Zeichen: Fortlaufende Nummer für jeweiliges Department

Funktionen, die mit :heavy_check_mark: markiert wurden, sind Basisfunktionalitäten.
...
|- Sortieren +
- Suche +
- Hinzufügen :heavy_check_mark: +
- Entfernen :heavy_check_mark:
|===
...
|Beschreibung
|#P-F-01
|Bestand anzeigen :heavy_check_mark:
...
_#P-F-03 und #P-F-04 entfallen_
...
|#P-F-06
|Produkte hinzufügen
|- Produkte können manuell hinzugefügt werden :heavy_check_mark: +
- Produkte können über eine BNN-Liste importiert werden

|#P-F-07
|Pfand :heavy_check_mark:
|Kunden können Pfand abgeben

|#P-F-08
|Entfernen von Produkten aus dem Inventar :heavy_check_mark:
...
|#F-F-01
|Online Merkzettel :heavy_check_mark:
|Es gibt einen online Merkzettel für Kunden (ohne Bestellfunktion)

|#F-F-02
|Preiskalkulation :heavy_check_mark: (vereinfacht)
...
|#F-F-04
|Informationen im Warenkorb :heavy_check_mark:
...
|#F-F-06
|Stornierungen :heavy_check_mark:
...
|#O-F-01
|Nachbestellen :heavy_check_mark:
|Der Manager kann Produkte über den Bestellassistenten nachbestellen. Dieser unterstützt ihn, in dem er das preislich beste Produkt markiert

|#O-F-02
|Lieferungsübersicht :heavy_check_mark:
|Es muss eine Übersicht von den bestellten Lieferungen geben

|#O-F-03
|Lieferungen
|- Der Manager muss Lieferungen dem Lager hinzufügen können +
- Falls eine Lieferung nicht ankommt, muss diese gelöscht werden können

|#O-F-04
|Mindestbestellmenge
|Es gibt eine Mindestbestellmenge für jedes Produkt bei Händlern. Diese muss im Bestellvorgang berücksichtigt werden
...
|User müssen sich einloggen können. Dies trifft nur fürs Personal zu

|#U-F-02
|Passwort ändern
|Das Personal kann das Passwort von sich ändern

|#U-F-03
|Passwort zurücksetzen
|Der Manager kann das Passwort von allen Mitarbeitern zurücksetzen (Standardpasswort)

|#U-F-04
|User bearbeiten
|Der Manager muss User bearbeiten können
