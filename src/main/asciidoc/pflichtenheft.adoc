...
|Personal| Das Personal interagiert mit dem System über die Kassenterminals im Bioladen. Es kann Waren zum Warenkorb hinzufügen und einen Gesamtpreis berechnen. Um das Wechselgeld für
den Kunden leichter bestimmen zu können, gibt der Verkäufer den genauen erhaltenen Betrag an und das System gibt ihm den Wechselgeldbetrag zurück. Das Personal kann außerdem über das
Terminal neue Hauskunden zum System hinzufügen. Es hat beschränkten Zugriff auf die Lieferantendatenbank (Lieferantenname, Ort) und kann einfache und globale Stornierungen im
Verkaufsvorgang durchführen.
...
den günstigsten Preis für zu bestellende Produkte zu finden und ihn beim Bestellvorgang unterstützt. Er bekommt außerdem eine Übersicht über die im Lager und im Laden gelagerten Produkte
...
Hauskunden auch Großkunden und Personal verwalten (Neue hinzufügen, Daten aktualisieren, Kunden/Personal löschen). Um einen Überblick über den Erfolg des Bioladens zu ermöglichen, erhält er
Zugriff auf die Verkaufszahlen, die ihm auch inform von Statistiken zur Verfügung stehen. Darüber hinaus kann er eine Gewinnspanne festlegen.
