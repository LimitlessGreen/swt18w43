...
|27.10.2018
|Lisa
|Dialoglandkart und Beschreibung ; Klasse & Enumerations
...
|OrderAssistant (Bestelungsassistant)  |hilft den Manager den günstigste Angebot bei den bestellbaren Produkten zu finden |
|===
