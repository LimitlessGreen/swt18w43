...
In diesem Diagramm wurden farbliche Pfeile benutz um den Zugriff darzustellen. Orange steht hierbei nur die Zugriffmöglichenkeiten als Kunden; Blau die des Verkaufspersonal und grün ist der volle Zugriff, der für den Manager vorhergesehen ist. Bitte beachten Sie hierbei die Vererbungen dabei ( z.B Manager kann alles machen, was das Verkaufspersonal kann)
