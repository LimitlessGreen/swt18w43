...
|===
|ID |[AT0010]
|Anwendungsfall |Einkauf mit Pfandrückgabe [UC0010]
...
|===
|ID |[AT0020]
|Anwendungsfall |erstellen einer Merkliste auf der Website [UC0020]
...
|===
|ID | [AT0030]
|Anwendungsfall | Nachbestellen mit OrderAssistant [UC0030]
...
|===
|ID | [AT0040]
|Anwendungsfall | Hinzufügen von Produkten zur OrderableProducts Liste [UC0040]
...
|===
|ID | [AT0050]
|Anwendungsfall | Hinzufügen von Kunden und bearbeiten des Kundentyps [UC0050]
